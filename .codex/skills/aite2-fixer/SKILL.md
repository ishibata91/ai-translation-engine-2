---
name: aite2-fixer
description: AI Translation Engine 2 専用。bugfix flow で確定した修正方針だけを実装する保守要員。原因調査ではなく、指示された修正だけを行いたいときに起動する。
---

# AITE2 Fixer

この skill は bugfix flow の fixer 役として、確定した修正方針だけを実装する。

## 使う場面
- debugger と bugfix 指揮者が fix scope を確定済み
- 最小修正だけを安全に反映したい
