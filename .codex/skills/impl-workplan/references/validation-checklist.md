...
- packet schema の gate として `powershell -ExecutionPolicy Bypass -File .codex/skills/scripts/validate-packet-contracts.ps1` も実行し、`changes/<id>/context_board/*.json` と `*.validation.json` を監査する。
