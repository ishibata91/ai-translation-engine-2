        ...
        <div className={`tab-content-panel flex-col gap-4 h-full min-h-0 overflow-hidden ${isActive ? 'flex' : 'hidden'}`}>
            ...
            <div className="flex gap-4 flex-1 min-h-0 overflow-hidden relative">
                <div className="w-1/2 flex flex-col border rounded-xl bg-base-100 overflow-hidden">
                        ...
                        <table className="table table-zebra table-pin-rows w-full select-none table-sm">
                            ...
                            <tbody>
                                <tr className="hover cursor-pointer bg-base-300">
                                    ...
                                    <td>
                                        <span className="badge badge-warning badge-xs text-white">確認済み</span>
                                    </td>
                                </tr>
                                <tr className="hover cursor-pointer">
                                    ...
                                    <td>
                                        <span className="badge badge-success badge-xs">AI翻訳済み</span>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                    ...
                    <div className="p-2 border-t flex justify-center bg-base-200 shrink-0">
                        <div className="join">
                            <button type="button" className="join-item btn btn-xs">
                                «
                            </button>
                            <button type="button" className="join-item btn btn-xs">
                                Page 1
                ...
                <div className="w-1/2 flex flex-col rounded-xl border bg-base-100 overflow-hidden">
                    ...
                    <div className="p-4 flex flex-col gap-4 flex-1 overflow-y-auto">
                        ...
                        <div className="collapse collapse-arrow bg-base-200 border border-base-300 rounded-box shrink-0">
                            ...
                            <div className="collapse-title font-bold text-sm">適用されたコンテキスト (Context DTO)</div>
                            <div className="collapse-content flex flex-col gap-2">
                                ...
                                <div className="alert shadow-sm p-2 flex-row justify-start gap-4 rounded-lg bg-base-100 border border-base-200 text-left">
                                    ...
                                    <span className="text-xs font-mono">arrow in the knee</span>
                                    <span className="text-xs">-&gt; 膝に矢を受けて</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="flex flex-col gap-1 shrink-0">
                            <label className="label pb-0">
                                <span className="label-text font-bold">原文 (Source)</span>
                            </label>
                        ...
                        <div className="flex flex-col gap-1 flex-1 relative min-h-[12rem]">
                            <div className="flex justify-between items-end shrink-0">
                                <label className="label pb-0">
                                    <span className="label-text font-bold">訳文 (Target)</span>
                                </label>
                            </div>
                            <textarea
                                className="textarea textarea-bordered textarea-primary flex-1 text-md leading-relaxed p-3"
                                defaultValue="そして膝に矢を受けてしまってな。"
                            ></textarea>
                        </div>
            ...
            <div className="flex justify-between items-center bg-base-200 p-2 rounded-xl border shrink-0 mt-auto">
                ...
                <div className="flex gap-2">
                    ...
                    <button type="button" className="btn btn-primary btn-sm" onClick={onNext} disabled={isTranslating}>
                        確定して次へ
                    </button>
                </div>
            </div>
