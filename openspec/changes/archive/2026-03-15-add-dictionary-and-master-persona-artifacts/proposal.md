...
### New Capabilities
- `artifact/dictionary-artifact`: Dictionary Builder の共有辞書成果物を artifact 正本として保存・検索する契約を定義する
- `artifact/master-persona-artifact`: MasterPersona の final 成果物と task 単位の中間生成物を artifact 正本として保存・検索する契約を定義する

### Modified Capabilities
- `slice/dictionary`: Dictionary Builder の共有辞書成果物を artifact 正本へ移し、slice 経由で保存・更新・検索する要件へ変更する
- `slice/persona`: MasterPersona の最終ペルソナ成果物と task 単位の中間生成物を artifact で管理し、一覧は生成済み成果物のみを表示し、下書き取得、ステータス表示、セリフ数表示を持たないよう要件を変更する
