...
| カラム | 型 | 説明 |
| :--- | :--- | :--- |
| `namespace` | TEXT NOT NULL | 名前空間 (例: `llm`, `dictionary`) |
...
## 関連ドキュメント
- [クラス図](config_class_diagram.md)
- [シーケンス図](config_sequence_diagram.md)
- [テスト設計](config_test_spec.md)
