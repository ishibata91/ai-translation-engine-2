...
// LoreInput is the input data required for building translation requests.
...
// Lore builds structured TranslationRequests from LoreInput.
...
type Lore interface {
	BuildTranslationRequests(data *LoreInput, config ContextEngineConfig) ([]TranslationRequest, error)
}
