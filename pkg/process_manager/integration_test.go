...
// Integration test for ProcessManager orchestration and recovery.
...
func (m *mockCfgForPM) Watch(ns, key string, cb config_store.ChangeCallback) config_store.UnsubscribeFunc {
	return func() {}
}
