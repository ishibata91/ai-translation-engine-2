...
// Process executes the parallel unmarshaling and returns the constructed ParserOutput.
func (p *ParallelProcessor) Process(ctx context.Context) (*ParserOutput, error) {
...
func (p *ParallelProcessor) launchUnmarshalWorkers(ctx context.Context, data *ParserOutput) chan error {
...
func (p *ParallelProcessor) unmarshalQuests(data *ParserOutput) error {
...
func (p *ParallelProcessor) unmarshalDialogueGroups(data *ParserOutput) error {
...
func (p *ParallelProcessor) unmarshalItems(data *ParserOutput) error {
...
func (p *ParallelProcessor) unmarshalNPCs(data *ParserOutput) error {
...
func (p *ParallelProcessor) unmarshalLocations(data *ParserOutput) error {
...
func (p *ParallelProcessor) unmarshalCells(data *ParserOutput) error {
...
func (p *ParallelProcessor) unmarshalMagic(data *ParserOutput) error {
...
func (p *ParallelProcessor) unmarshalSystem(data *ParserOutput) error {
...
func (p *ParallelProcessor) unmarshalMessages(data *ParserOutput) error {
...
func (p *ParallelProcessor) unmarshalLoadScreens(data *ParserOutput) error {
